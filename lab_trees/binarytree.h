...
class BinaryTree
{
    public:
        ...
        void isOrderedRecursive(Node* root, std::vector<T>& nodes) const;
        ...
        void getPaths(std::vector<std::vector<T>>& paths, std::vector<T> temp, Node* root) const;
        ...
        int sumDistances(Node* root, int dist) const;
